...
${a}
limit ${s}
`}},"genSingleLogQuery",0,(e,t)=>`select id, timestamp, event_message, metadata from ${e} where id = '${t}' limit 1`,"isDefaultLogPreviewFormat",0,e=>e&&e.timestamp&&e.event_message&&e.id,"isUnixMicro",0,d,"jwtAPIKey",()=>v,"maybeShowUpgradePromptIfNotEntitled",0,(e,t)=>!!t&&Math.abs((0,s.default)().diff((0,s.default)(e),"day"))>t,"role",()=>E,"unixMicroToIsoTimestamp",0,c,"useEditorHints",0,()=>{let e=(0,t.useMonaco)();(0,a.useEffect)(()=>{if(e){let t=e.languages.registerCompletionItemProvider("pgsql",{triggerCharacters:["`"," ","."],provideCompletionItems:function(t,r,s){let o=new u.default(t,r.column-2,r.lineNumber-1);if(o.isNextDQuote())return{suggestions:[]};let a=[],l=i.default.schemas.filter(e=>o._text.includes(e.reference));if(0===l.length&&(l=i.default.schemas),o.isNextPeriod()){let t=l.flatMap(e=>e.fields).flatMap(e=>{let[t,...r]=e.path.split(".");return r}).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));a=a.concat(t)}if("`"===s.triggerCharacter||" "===s.triggerCharacter){let t=i.default.schemas.map(t=>({label:t.reference,kind:e.languages.CompletionItemKind.Class,insertText:t.reference})),r=l.flatMap(e=>e.fields).flatMap(e=>e.path.split(".").slice(0,-1)).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));a=(a=a.concat(r)).concat(t)}return{suggestions:(0,n.default)(a,"label")}}});return()=>{t.dispose()}}},[e])}])},993394,e=>{"use strict";e.i(128328);var t,r=e.i(86086),s=e.i(55956),o=e.i(10429);let n=`${o.DOCS_URL}/guides/platform/logs#querying-with-the-logs-explorer`,a=[{label:"Recent Errors",mode:"simple",searchString:"[Ee]rror|\\s[45][0-9][0-9]\\s",for:["api"]},{label:"Commits",mode:"simple",searchString:"COMMIT",for:["database"]},{label:"Commits By User",description:"Count of commits made by users on the database",mode:"custom",searchString:`select
  p.user_name,
  count(*) as count
from postgres_logs
