...
export default function InfoModal({ isOpen, onClose, onProceed }) {
  return (
    <AnimatePresence>
      {isOpen ? (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-8 md:px-8 md:py-10">
              <p className="font-body text-xs uppercase tracking-[0.7em] text-red-300/65">Join TEDx MSRIT</p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <button
                  type="button"
                  onClick={onProceed}
                  className="inline-flex flex-1 items-center justify-center gap-3 rounded-full border border-red-500/30 bg-red-600 px-6 py-4 font-body text-sm font-semibold uppercase tracking-[0.28em] text-white transition hover:bg-red-500"
                >
                  Proceed to Register
